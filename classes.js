...
class ProgressiveManager extends Manager{
    ...
    hire(employee){
        ...
        switch (true) {
            case (x===0) : this.title = 'Not a manager'
            break;
            case (x>=1&&x<=3) : this.title = 'Barely Manager'
            break;
            case (x>=4&&x<=10) : this.title = 'Mostly Manager'
            break;
            case (x>=11&&x<=50) : this.title = 'Manager'
            break;
            case (x>=51&&x<=100) : this.title = 'Manager Plus'
            break;
            case (x>=101) : this.title = 'Bestest Manager'
            break;
        }
      }
    fire(index){
